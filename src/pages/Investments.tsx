        ...
        {!isLoading && (
          <>
            <div className="flex flex-col gap-[16px]">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-[16px]">
                <KpiCard
...
function KpiCard({
  ...
  return (
    ...
    >
      ...
      <div className={`text-[15px] md:text-[20px] font-semibold tracking-[-0.02em] tabular-nums leading-none truncate ${valueClass ?? "text-foreground"}`}>
        {value}
      </div>
      {subtext && (
