...
export function HeroSection() {
  ...
  return (
    <section
      ...
      style={{ background: "#1b76ff", minHeight: "130vh" }}
    >
      {/* Ghost text — LIKE NEVER BEFORE, bottom-anchored, clearly below main content */}
      <div
      ...
      {/* Main content */}
      <div
        className="container px-4 md:px-6 relative pt-28 lg:pt-36 pb-12"
        style={{ zIndex: 10 }}
      >
        {/* Top-right description */}
        <div className="hidden lg:block absolute right-6 xl:right-14 top-36 max-w-[220px] text-white">
            ...
            <span className="flex items-center gap-5 lg:gap-7 flex-wrap lg:flex-nowrap">
              ...
              >
                ...
                <div className="text-white">
                  <div className="text-[9px] tracking-[0.24em] font-bold opacity-60 mb-1">
                    FREE FOREVER
                  </div>
