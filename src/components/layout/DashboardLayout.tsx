...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background dashboard-theme relative overflow-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 pt-6 md:pt-8" style={{ paddingLeft: 'calc((100% - min(100% - 2rem, 80rem)) / 2 + 1.5rem)', paddingRight: 'calc((100% - min(100% - 2rem, 80rem)) / 2 + 1.5rem)' }}>
