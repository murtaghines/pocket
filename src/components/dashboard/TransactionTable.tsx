          ...
          <Table className="table-fixed w-full">
             <TableHeader>
              <TableRow className="bg-muted/30 hover:bg-muted/30">
                <TableHead className="hidden sm:table-cell whitespace-nowrap w-[55px]">{t('transactions.month', { defaultValue: 'Month' })}</TableHead>
                <TableHead className="hidden sm:table-cell whitespace-nowrap w-[88px]">{t('transactions.date')}</TableHead>
                <TableHead>{t('transactions.description')}</TableHead>
                <TableHead className="hidden md:table-cell whitespace-nowrap w-[90px]">{t('transactions.movement', { defaultValue: 'Movement' })}</TableHead>
                <TableHead className="hidden md:table-cell whitespace-nowrap w-[44px]">{t('transactions.category')}</TableHead>
                <TableHead className="hidden lg:table-cell whitespace-nowrap w-[110px]">{t('transactions.bank', { defaultValue: 'Account' })}</TableHead>
                <TableHead className="text-right whitespace-nowrap w-[100px]">{t('transactions.amount')}</TableHead>
                <TableHead className="text-right hidden lg:table-cell whitespace-nowrap w-[88px]">{t('transactions.balance', { defaultValue: 'Balance' })}</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
