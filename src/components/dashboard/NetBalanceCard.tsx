...
export function NetBalanceCard({
  ...
  return (
    <div
      className="flex h-full items-stretch gap-3 rounded-xl bg-primary p-3 md:p-5 text-primary-foreground shadow-glow"
    >
      {/* Balance */}
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="mt-auto">
          <div className="text-[16px] md:text-[20px] font-semibold tabular-nums leading-none tracking-[-0.02em] truncate">
